...
admin=["Yu8c000e29e242faec9af2e018d62a185b"]
wait = {
    'contact':True,
    'autoJoin':True,
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Keys","Key","keys"]:
                if wait["lang"] == "JP":
                ...
                if msg.toType == 2:
                    ...
                    X.name = msg.text.replace("Gn "u8c000e29e242faec9af2e018d62a185b,"")
                    cl.updateGroup(X)
                else:
                ...
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Cv1 gn "uc98915ea43578b91c523b2d9cd04f2fd,"")
                    ki.updateGroup(X)
                else:
                ...
                midd = msg.text.replace("Kick "u8c000e29e242faec9af2e018d62a185b,"")
                cl.kickoutFromGroup(msg.to,[midd])
            elif "Cv1 kick " in msg.text:
                midd = msg.text.replace("Cv1 kick "uc98915ea43578b91c523b2d9cd04f2fd,"")
